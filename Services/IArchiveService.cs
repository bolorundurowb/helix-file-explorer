...
/// <summary>Reads entries out of zip/7z/rar/tar archives as if they were virtual folders.</summary>
public interface IArchiveService
{
    ...
    /// <summary>
    /// Lists the children of <paramref name="virtualPath"/> inside an archive.
    ...
    /// <summary>
    /// Extracts a single virtual file to a temporary location and returns the on-disk path,
    /// so callers can drag the file out of the archive or open it. Returns null on failure.
    /// </summary>
